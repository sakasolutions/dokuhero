...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .header { border-bottom: 2px solid #334155; padding-bottom: 14px; margin-bottom: 20px; display: flex; justify-content: space-between; align-items: flex-start; gap: 16px; }
    ...
    .betrieb { font-size: 22pt; font-weight: 800; color: #b45309; letter-spacing: -0.02em; }
