    ...
    <div className="space-y-4">
      <div className="flex flex-wrap gap-3">
        <button
          ...
          className="inline-flex min-h-12 min-w-[120px] flex-1 items-center justify-center gap-2 rounded-xl bg-primary px-4 py-3 text-base font-semibold text-white shadow-md transition hover:bg-teal-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"
